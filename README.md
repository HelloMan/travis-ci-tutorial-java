[![Build Status](https://travis-ci.org/helloman/travis-ci-tutorial-java.svg?branch=master)](https://travis-ci.org/helloman/travis-ci-tutorial-java)
[![Code Coverage](https://codecov.io/github/helloman/travis-ci-tutorial-java/coverage.svg)](https://codecov.io/gh/helloman/travis-ci-tutorial-java)
...
1. [Fork](https://github.com/helloman/travis-ci-tutorial-java/fork) this Repository
2. Go to [Travis CI](http://travis-ci.com) and enable the repository
3. Fix the `README.md` badges (replacing in the URL `helloman` with `your-github-username`) and push the changes. This should trigger a build in Travis CI!
...
[Open an Issue](https://github.com/helloman/travis-ci-tutorial-java/issues/new)!
